    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_status', models.CharField(max_length=100, choices=[(b'Storyboard', b'Storyboard'), (b'Filming', b'Filming'), (b'Post Production', b'Post Production'), (b'Waiting for Approval', b'Completed-Waiting for Approval'), (b'Approvaed', b'Completed-Approvaed')])),
                ...
                ('production_team', models.ForeignKey(related_name='production_team', to='people.Animator')),
